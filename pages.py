...
:root{
  ...
  --accent:#3b82f6;--accent2:#1d4ed8;--accent3:#22c55e;
...
/* Animations are OFF by default (product default); prefers-reduced-motion still respected either way */
...
<div class="wrap">
  ...
  <div class="brand-caps">EMERYZONE</div>
  <h1 data-i18n="h1"></h1>
  <p class="subtitle" data-i18n="subtitle"></p>

  <div class="login-status"><span class="live"></span><span>EMERYZONE · SECURE ADMIN CONSOLE</span><span style="margin-right:auto;color:#6ee7b7">ONLINE</span></div>
  <div class="card">
  ...
  <div class="foot">EmeryZone Control Center &copy; <span data-i18n="rights"></span></div>
</div>
...
var I18N = {
  fa: {
    title: "ورود | EmeryZone",
    h1: 'ورود به <span class="g">Emeryzone</span>',
    subtitle: "مرکز کنترل امن EmeryZone برای مدیریت سرویس‌ها و شبکه",
    ...
    adminRegTitle: "ثبت‌نام ادمینی EmeryZone",
  ...
  en: {
    title: "Login | EmeryZone",
    h1: 'Sign in to <span class="g">Emeryzone</span>',
    subtitle: "Secure EmeryZone control center for services and network",
    emailLabel: "Username",
    emailPh: "admin",
    passLabel: "Password",
    ...
    adminRegTitle: "EmeryZone admin registration",
...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>EmeryZone Control Center</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
:root{
  ...
  --accent:#3b82f6;--accent-d:#1d4ed8;--good:#22c58b;--warn:#f5a524;--bad:#f24955;
...
[data-theme="light"]{
  ...
  --accent:#3b82f6;--accent-d:#1d4ed8;--good:#17a673;--warn:#c9820a;--bad:#e0324a;
...
/* EmeryZone 17 — original premium control-center skin */
...
<script>(function(){
  ...
  // به‌نام «ez_theme» می‌خواند که هیچ‌جای برنامه هرگز در آن چیزی نمی‌نوشت
  // (تنظیمات واقعی همیشه زیر کلید «ez_appearance» ذخیره می‌شود)، پس همیشه
  ...
  try{
    var raw = localStorage.getItem('ez_appearance');
...
<div id="app">
  ...
  <div class="body-wrap">
    ...
    <div class="page on" id="pg-overview">
      <div class="pg-head"><div><div class="eyebrow"><span class="live-dot"></span> LIVE SYSTEM MONITOR</div><h1>مرکز کنترل EmeryZone</h1><p>نمای لحظه‌ای منابع سرور، ترافیک، اتصال‌ها و سرویس فروش.</p></div>
    ...
    <div class="page" id="pg-links">
      <div class="pg-head inbound-head"><div><div class="eyebrow"><span class="live-dot"></span> EMERYZONE CORE · <span id="ibLiveTag">LIVE</span></div><h1>اینباندها</h1><p>مرکز مدیریت اینباند، ساخت کلاینت و کنترل دسترسی؛ با پایش زنده هر ۵ ثانیه.</p></div>
        <div class="toolbar">
    ...
    <div class="page" id="pg-clientmgr">
      <div class="pg-head"><div><div class="eyebrow"><span class="live-dot"></span> EMERYZONE · CLIENT MANAGER</div><h1>ساخت کلاینت</h1><p>یک اینباند را انتخاب کن و از روی همان کلاینت‌های واقعی (زیرمجموعه) بساز؛ بدون نیاز به رفتن به صفحه اینباندها.</p></div>
    ...
    <div class="page" id="pg-admins">
      <div class="pg-head"><div><div class="eyebrow"><span class="live-dot"></span> EMERYZONE · مدیریت حساب</div><h1>مدیریت حساب‌ها</h1><p>اینجا همه حساب‌های مدیریتی پنل را مرتب و دقیق مدیریت می‌کنیم؛ از ساخت ادمین تا تعیین دسترسی و کنترل وضعیت حساب.</p></div>
    ...
    <div class="page" id="pg-settings">
      ...
      <div class="appearance-studio">
        ...
        <div class="appearance-card appearance-preview"><div class="preview-window"><div class="preview-top"><i class="ti ti-circle-filled"></i><i class="ti ti-circle-filled"></i><i class="ti ti-circle-filled"></i></div><div class="preview-main"><div class="preview-side"><div class="active"></div><div></div><div></div><div></div></div><div class="preview-content"><div class="pv-title">EmeryZone Control Center</div><div class="pv-sub">Live system overview</div><div class="pv-cards"><span></span><span></span><span></span></div></div></div></div></div>
      </div>
...
// Appearance Studio
// ============================================================
const APPEARANCE_DEFAULTS={font:'Vazirmatn',theme:'dark',accent:'blue',density:'comfortable',motion:false,wide:false,radius:'soft',glow:true,fontSize:'normal'};
...
function getAppearance(){try{return {...APPEARANCE_DEFAULTS,...JSON.parse(localStorage.getItem('ez_appearance')||'{}')}}catch(e){return {...APPEARANCE_DEFAULTS}}}
function saveAppearance(a){try{localStorage.setItem('ez_appearance',JSON.stringify(a))}catch(e){} applyAppearance()}
...
function resetAppearance(){try{localStorage.removeItem('ez_appearance');localStorage.removeItem('ez_theme')}catch(e){};applyAppearance();toast('ظاهر پنل به حالت پیش‌فرض برگشت ✓')}
applyAppearance();
