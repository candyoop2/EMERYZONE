...
SALES_FILE = DATA_DIR / "emeryzone_sales.json"
SALES_LOCK = asyncio.Lock()

PLANS_FILE = DATA_DIR / "emeryzone_plans.json"
...
async def fulfill_payment(user, plan_id, telegram_charge_id=""):
    ...
    uid, link=await make_link(
        ...
        expires_at=expires,
        protocol=os.environ.get("EMERYZONE_SALES_PROTOCOL","vless-ws"),
        fingerprint="chrome",
        alpn="http/1.1",
        port=int(os.environ.get("EMERYZONE_SALES_PORT","443")),
